...
/* "drones/tanpura.wav" => string FILENAME; */
/* "drones/basal-1.wav" => string FILENAME; */
/* "drones/einstein.wav" => string FILENAME; */
/* "drones/wtx-0.wav" => string FILENAME; */
"drones/tuvan.wav" => string FILENAME;
/* "tanpura.wav" => string FILENAME; */
...
// patch it
PoleZero blocker => NRev reverb => Gain g => dac;
// connect
/* lisa.chan(0) => blocker; */
lisa => blocker;
...
while( true )
{
    ...
    /* GRAIN_LENGTH / 4  + Math.random2f(0,GRAIN_FIRE_RANDOM)::ms => now; */
}
        ...
        while( hi.recv( msg ) )
        {
            ...
            if( msg.isButtonDown() )
            {
                ...
                else if( msg.which == KEY_RIGHT )
                {
                    ...
                    1.05946 *=> GRAIN_PLAY_RATE;
                    /* 2 *=> GRAIN_PLAY_RATE; */
                    if( GRAIN_PLAY_RATE > 32 ) 32 => GRAIN_PLAY_RATE;
                }
